const passwordResetMessage = (to, username, text, verificationLink) => {
  return {
    to,
    from: 'christosmanoloulis@gmail.com',
                            ...
                            <tr>
                              <td
                                            ...
                                            <tr>
                                              <td
                                                          ...
                                                          <div
                                                            ...
                                                            <span
                                                              style="
                                                                ...
                                                                color: #000000;
                                                              "
                                                              >Please click the link bellow to</span
                                                            ><span
                                                              style="
                                                                color: #000000;
                                                                font-size: 18px;
                                                ...
                                                <table
                                                  ...
                                                  width="100%"
                                                  style="table-layout: fixed"
                                                  data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e.1"
                                                  data-mc-module-version="2019-10-22">
                                                  <tbody>
                                                    <tr>
                                                      <!--PARAGRAPH-->
                                ...
                                <table
                                  ...
                                  style="table-layout: fixed"
                                  width="100%"
                                  data-muid="550f60a9-c478-496c-b705-077cf7b1ba9a"></table>
                              </td>
                            </tr>
                          </table>
                          <!--[if mso]>
